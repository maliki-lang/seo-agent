...
class KeywordAnalyzer:
    ...
    def _analyze_keyword(
        ...
        if len(keyword_words) > 1:
            # Look for variations like "comfortable shoes" -> "shoes comfortable" or "your comfortable shoes"
...
if __name__ == "__main__":
    sample_content = """
# Comfortable Shoes for Standing All Day: A Guide

Finding comfortable shoes has never been easier. In this guide, you'll learn how to choose comfortable shoes.

## Choosing Your Footwear Topic

When you start a footwear, the first step is choosing your topic. Your footwear topic should be something you're passionate about.

## Getting Footwear Equipment

To start a footwear, you need basic equipment. A good microphone is essential for footwear recording.

## Comfortable Footwear Platforms

Footwear hosting is crucial. Choose a reliable comfortable footwear platform for your show.
    """

    result = analyze_keywords(
        sample_content,
        "start a footwear",
        ["comfortable footwear", "footwear equipment", "footwear recording"],
        target_density=1.5
    )
