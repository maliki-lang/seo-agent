...
if __name__ == "__main__":
    ...
    result1 = analyze_intent("how to choose comfortable shoes")
    ...
    result2 = analyze_intent(
        "best comfortable shoe brands singapore",
        serp_features=['carousel', 'people_also_ask', 'video'],
        top_results=[
            {'title': 'Top 10 Comfortable Shoe Brands in Singapore', 'description': 'Compare the best...'},
            {'title': 'Best Comfortable Footwear Services: Review', 'description': 'Our expert review...'}
        ]
    )
