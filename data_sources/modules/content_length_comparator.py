...
if __name__ == "__main__":
    ...
    mock_serp = [
        {'url': 'https://example1.com/shoe-guide', 'domain': 'example1.com', 'title': 'How to Choose Comfortable Walking Shoes'},
        {'url': 'https://example2.com/shoe-tutorial', 'domain': 'example2.com', 'title': 'Shoe Tutorial'},
        {'url': 'https://example3.com/shoe-comfort-101', 'domain': 'example3.com', 'title': 'Shoe Comfort 101'},
    ]
    ...
    example_output = {
        'keyword': 'how to choose comfortable shoes',
