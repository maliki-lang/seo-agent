...
class OpportunityScorer:
    ...
    def calculate_score(
        ...
        # Apply learned-weight multiplier from post-publish feedback loop.
        # Returns 1.0 (no effect) until enough checkpoint data has accumulated.
        try:
            from .learned_weights import get_weight as _learned_get_weight
            learned_multiplier = _learned_get_weight(
                cluster=cluster,
        ...
        final_score = raw_score * learned_multiplier

        # Determine priority level (uses learned-adjusted score)
        ...
        return {
            ...
            'learned_multiplier': round(learned_multiplier, 4),
