...
class EngagementAnalyzer:
    ...
    GENERIC_OPENERS = [
        ...
        r'^(?:Footwear|Shoe|Content)\s+(?:comfort|marketing|design)\s+(?:is|has|can)',
        r'^If you\'re (?:looking|searching|trying)',
        r'^(?:Many|Most|Some)\s+(?:customers?|creators?|people)',
    ...
    NAME_PATTERNS = [
        ...
        r'\b[A-Z][a-z]+\'s (?:shoes|routine|company|business|team|day)\b',  # "Sarah's footwear"
    ]
