...
- **Content Gaps**: Topics competitors rank for but Sunnystep doesn't
...
# Google Search Console
GSC_SITE_URL=https://sunnystep.com
...
trends = ga.get_page_trends(
    url="/blog/footwear-monetization-guide",
    days=90
)
...
rankings = dfs.get_rankings(
    keywords=["footwear hosting", "footwear analytics"]
)

# Analyze competitor rankings
competitor_data = dfs.analyze_competitor(
    competitor_domain="competitor.com",
    keywords=["footwear hosting"]
)

# Get SERP data
serp = dfs.get_serp_data(keyword="footwear monetization")
```
...
#   },
#   'dataforseo': {
#     'primary_keyword': 'footwear monetization',
#     'position': 8,
#     'search_volume': 2900
#   }
# }
