...
This guide provides step-by-step instructions for setting up the data source integrations used by Sunnystep SEO agent: Google Analytics 4 (GA4), Google Search Console, DataForSEO, and WordPress.
...
2. Select or create a project for your Sunnystep SEO agent integration
...
3. Fill in the service account details:
   ...
   - **Description**: "Service account for Sunnystep SEO agent GA4 integration"
...
3. Fill in the service account details:
   ...
   - **Description**: "Service account for Sunnystep SEO agent GSC integration"
4. Click **Create and Continue**
...
WordPress integration enables publishing articles and landing pages directly from Sunnystep SEO agent via the REST API.
...
4. Enter a name: `Sunnystep SEO agent`
