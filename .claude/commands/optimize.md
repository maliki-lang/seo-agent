...
- **Quantity**: Count current internal links to Sunnystep content
...
- **Brand**: Consider adding "| Sunnystep" if space allows
- **Uniqueness**: Distinct from other Sunnystep page titles
...
- **Messaging**: Ensure messaging reflects Sunnystep positioning
- **Product Mentions**: Natural integration of Sunnystep features
...
Example: `drafts/optimization-report-comfortable-work-shoes-2025-10-15.md`
...
This ensures every article meets Sunnystep quality standards and SEO best practices before going live.
