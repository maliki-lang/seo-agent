...
**Competitor Gaps**:
- Keywords competitors rank for but Sunnystep doesn't
...
1. Optimize for "footwear analytics dashboard"
   Type: Quick Win
   Current Position: 12
...
1. **Quick Win Identified**: "comfortable work shoes" at position 13
   ```
   /analyze-existing /blog/footwear-monetization-guide
   /optimize drafts/footwear-monetization-guide.md
   ```

2. **Declining Content**: Article lost 35% traffic
   ```
   /analyze-existing /blog/footwear-equipment-guide
   /rewrite footwear equipment guide
   ```
...
4. **Trending Topic**: "AI footwear tools" +150% growth
   ```
   /research AI footwear tools
   /write AI footwear tools
   ```

5. **Competitor Gap**: competitor.com ranks #3, Sunnystep not ranking
   ```
   /research footwear editing workflow
   /write footwear editing workflow
   ```
...
- Optimized "footwear analytics" article
